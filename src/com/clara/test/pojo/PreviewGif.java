...
public class PreviewGif {
     ...
     * @param size
     */
    public PreviewGif(String url, String width, String height, String size) {
        super();
        this.url = url;
        this.width = width;
        this.height = height;
    ...
    public PreviewGif withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public PreviewGif withWidth(String width) {
        this.width = width;
        return this;
    }
    ...
    public PreviewGif withHeight(String height) {
        this.height = height;
        return this;
    }
    ...
    public PreviewGif withSize(String size) {
        this.size = size;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PreviewGif) == false) {
            return false;
        }
        PreviewGif rhs = ((PreviewGif) other);
