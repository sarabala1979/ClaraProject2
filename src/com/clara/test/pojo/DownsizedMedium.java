...
public class DownsizedMedium {
    ...
    public DownsizedMedium withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public DownsizedMedium withWidth(String width) {
        this.width = width;
        return this;
    }
    ...
    public DownsizedMedium withHeight(String height) {
        this.height = height;
        return this;
    }
    ...
    public DownsizedMedium withSize(String size) {
        this.size = size;
        return this;
    }
